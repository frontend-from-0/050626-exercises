...
console.log("Ex. 17. Sum of these three numbers is:", bundlePartOne + bundlePartTwo + bundlePartThree);
...
console.log("Ex. 18.1. The result is:", divisionQuotient);

const subtractionDifference = divisionDividendAmount - divisionDivisorAmount;
console.log("Ex. 18.2. The result is:", subtractionDifference);
...
console.log('Ex.20. The Result is:', productFactorSeven * productFactorTwo);


// 21. Log the value of Math.PI.
// CODE HERE

console.log('Ex. 21. The Value of Pi is:', Math.PI);
...
console.log('Ex.22.1 The Result is:', demonstrationCounter);


demonstrationCounter += 1;

console.log('Ex.22.2 The Result is:', demonstrationCounter);


demonstrationCounter = demonstrationCounter + 1;

console.log('Ex.22.3 The Result is:', demonstrationCounter);
...
console.log('Ex. 23.1. Weather is now', baselineCelsiusTemp,'degrees');

baselineCelsiusTemp += 5;

console.log('Ex. 23.2. Later it will be', baselineCelsiusTemp, 'degrees');
...
console.log('Ex. 24.1:', ++valueForPrefixIncrement);

console.log('Ex. 24.2:', valueForPrefixIncrement);
...
console.log('Ex. 25.1.', valueForPostfixIncrement++);

console.log('Ex. 25.2.', valueForPostfixIncrement);
...
console.log('Ex. 26. The Final result is:', valueBeforeDoubleStep * 2);
...
console.log('Ex. 27. The Final Result is:', prefixBaseValue + addedNeighborValue);