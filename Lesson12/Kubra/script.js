...
console.log(
  "Ex.17. the sum is:",
  bundlePartOne + bundlePartTwo + bundlePartThree,
);
...
console.log("Ex.18. the division is:", divisionQuotient);
console.log("Ex.18.1 the subtraction is:", subtractionDifference);
...
// CODE HERE
const applicantFirstName = "Kübra";
const applicantLastName = "Altun";
const applicantFullName = applicantFirstName + " " + applicantLastName;

console.log("Ex.19. The full name is:", applicantFullName);
...
console.log(
  "Ex.20. Result of the product is:",
  productFactorSeven * productFactorTwo,
);
...
console.log("Ex.22. counter1:", demonstrationCounter);

demonstrationCounter += 1;
console.log("Ex.22.1 counter2:", demonstrationCounter);

demonstrationCounter = demonstrationCounter + 1;
console.log("Ex.22.2 counter3:", demonstrationCounter);

// 23. Declare baselineCelsiusTemp=20. Increase it by 5 and log the result.
// CODE HERE
let baselineCelsiusTemp = 20;
baselineCelsiusTemp += 5;
console.log("Ex.23. Increase baselineCelsiusTemp by 5:", baselineCelsiusTemp);
...
console.log("Ex.24. expression result is:", ++valueForPrefixIncrement);
console.log("Ex.24.1 variable after the update is:", valueForPrefixIncrement);
...
console.log("Ex.25. expression result is:", valueForPostfixIncrement++);
console.log(
  "Ex.25.1 variable after the update is:",
...
console.log("Ex.25. increment value by 1:", ++valueBeforeDoubleStep);
console.log("Ex.25.1 result of multiply:", valueBeforeDoubleStep * 2);
...
console.log("Ex.27.  Increment prefixBaseValue:", ++prefixBaseValue);
console.log(
  "Ex.27.1 result of add addedNeighborValue:",
